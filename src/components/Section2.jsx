...
export default function Section2({tittle, subtittle1, subtittle2, year1, year2, text1, text2, text3, text4, text5, text6}) {
    return (
                        ...
                        <ul className="row row-cols-1 row-cols-lg-2 p-0" style={{listStyle: 'none'}}>
                            <XyzTransition appearVisible xyz="fade-100% left-50% duration-15">
                                <li className="mt-4 text-sm-center">
                                    <ul className="fs-4 fw-bold" style={color}>{subtittle1} (<span className="text-white fw-normal">Freelancer</span>)</ul>
                            ...
                            <XyzTransition appearVisible xyz="fade-100% right-50% duration-15">
                                <li className="mt-4 text-sm-center">
                                    <ul className="fs-4 fw-bold" style={color}>{subtittle2} (<span className="text-white fw-normal">Freelancer</span>)</ul>
