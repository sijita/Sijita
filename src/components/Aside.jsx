    ...
    return (
        <aside>
            <ul className="text-center d-flex flex-column p-0 fixed-bottom mb-0 d-none d-sm-block" style={{ listStyle: 'none', width: 60 }}>
                <Red xyz={xyza} href="https://www.facebook.com/simon.jimeneztamayo/" icon={[<FiFacebook className="fs-4" style={{color: '#96a4b3'}} />]} />
                <Red xyz={xyzb} href="https://api.whatsapp.com/send?phone=573193139280&text=Hola!%20Vi%20tu%20portafolio%20y%20estoy%20interesado%20en%20una%20p%C3%A1gina."
                    icon={[<IoLogoWhatsapp className="fs-4" style={{color: '#96a4b3'}} />]} />
                <Red xyz={xyzc} href="https://www.instagram.com/simonjimenezt/" icon={[<IoLogoInstagram className="fs-4" style={{color: '#96a4b3'}} />]} />
                <Red xyz={xyzd} href="https://github.com/sijita" icon={[<FiGithub className="fs-4" style={{color: '#96a4b3'}} />]} />
