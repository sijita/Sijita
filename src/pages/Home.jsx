    ...
    <React.Fragment>
      ...
      <Section1
        descripcion={[
          ...
          ", tengo 20 años y soy estudiante de 7mo semestre de Ingeniería de Software en la Universidad Surcolombiana, ubicada en Neiva-Huila ",
          <span style={{ backgroundColor: "#BAFF29",
          backgroundImage: "linear-gradient(45deg, #baff29 0%, #3fea2f 100%)",
          WebkitBackgroundClip: "text",
          backgroundClip: "text",
